...
test('🛒 Add to Cart Flow - Magnetic Badges (SingaPrinting) - All Shapes', async ({ page }) => {
  ...
  try {
    ...
    console.log('📸 Error screenshot saved as error-navigation.png');
    throw error;
  }
  ...
  // Allow limiting how many items to add to cart via ENV: CART_LIMIT (number) or FAST=true (adds 1)
  ...
  await scrollAndClick(page, finishing.xpath, `Finishing: ${finishing.name}`);
        ...
        for (const qty of quantities) {
          ...
          try {
            ...
            // Verify product page is interactive again
            ...
            console.log('✅ Cart modal closed and product page is interactive');
