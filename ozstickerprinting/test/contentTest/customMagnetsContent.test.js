...
const expected = JSON.parse(fs.readFileSync('ozstickerprinting/test/testData/customMagnetsContent.json', 'utf-8'));
...
test.describe('🧾 Product Page: Custom Magnets', () => {
  ...
  test.describe('📦 Product Info Section', () => {
    test('Verify product details, shapes & downloads', async ({ page }) => {
