...
export const ospConfig = {
  ...
  environment: {
    live: {
      baseUrl: 'https://www.ozstickerprinting.com/',
      productSample: 'https://www.ozstickerprinting.com/stickers/paper/art?featured=art-paper-roll', // sample product
    },
    dev: {
      baseUrl: 'https://dev.ozstickerprinting.com/',
      buttonBadges: 'https://dev-new-product.ozstickerprinting.com/badges/button-badge?featured=1', // sample product
    },
  },
  ...
  urls: {
    home: 'https://www.ozstickerprinting.com/',
    productSample: 'https://www.ozstickerprinting.com/stickers/paper/art?featured=art-paper-roll', // sample product
  },
};
